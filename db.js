    ...
    initDatabase() {
        ...
        if (!localStorage.getItem('schedules')) {
            localStorage.setItem('schedules', JSON.stringify([
                { id: 1, routeId: 1, busId: 1, driverId: 1, date: '2026-04-05', departureTime: '08:00', arrivalTime: '13:00', status: 'scheduled' },
                { id: 2, routeId: 1, busId: 2, driverId: 2, date: '2026-04-05', departureTime: '14:00', arrivalTime: '19:00', status: 'scheduled' },
                { id: 3, routeId: 2, busId: 1, driverId: 1, date: '2026-04-06', departureTime: '12:00', arrivalTime: '12:00', status: 'scheduled' }
            ]));
        }
